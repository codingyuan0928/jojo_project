...
public class ProductRestController {
    ...
    @GetMapping("/select_homepage")
    public String selectHomepage() {
        return "select_homepage";
    }

    @GetMapping("/shop_homepage")
    public String shopHomepage(HttpServletRequest req, Model model, HttpServletResponse res) {
    ...
    @PostMapping("/search_product_name")
    public String searchProductName(HttpServletRequest req, Model model, HttpServletResponse res) {
        ...
        List<ProVO> search = proSvc.getSearchnam(keyin);
    ...
    @GetMapping("/choose_popular")
    public String choosePopular(HttpServletRequest req, Model model, HttpServletResponse res) {

        /******************下拉式選單功能  1. 開始查詢資料 **********************/
        List<ProVO> popular = proSvc.getPopular();
    ...
    @GetMapping("/choose_new")
    public String chooseNew(HttpServletRequest req, Model model, HttpServletResponse res) {

        /*************************** 1.開始查詢資料�  **********************/

        List<ProVO> newer = proSvc.getNew();
    ...
    @GetMapping("/choose_price")
    public String choosePrice(HttpServletRequest req, Model model, HttpServletResponse res) {
/*************************** 1.開始查詢資料 **********************/
        List<ProVO> popular = proSvc.getPrice_LtoH();
...
/***************************2. 查詢完成,準備轉交(Send the Success view)*************/
    ...
    @GetMapping("/get_product_photo")
    public void getProductPhoto(HttpServletRequest req, Model model, HttpServletResponse res) throws IOException {
    ...
    @GetMapping("/get_product_multi_photo")
    public void getProductMultiPhoto(HttpServletRequest req, Model model, HttpServletResponse res) throws IOException {
        res.setContentType("image/gif");
        ServletOutputStream out = res.getOutputStream();
...
System.out.println("list.size"+ list.size());
 ...
 System.out.println("i"+ i);
    ...
    @GetMapping("/tocart")
    public String toCart(HttpServletRequest req, Model model, HttpServletResponse res) {
        ...
        ProVO proVO = proSvc.getProductById(str);
        req.setAttribute("proVO", proVO);


        List<ProVO> proVO_ad = proSvc.getAd();
