...
class PhotoWriteCourt {
	...
	public static void main(String argv[]) {
		...
		String photos = "src/main/resources/static/images/court"; //測試用圖片已置於【專案錄徑】底下的【resources/DB_photos1】目錄內
		String update = "update group_lists set group_pic =? where group_id=?";
